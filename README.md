...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/metamorph.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/metamorph)
...
```bash
php artisan vendor:publish --tag="metamorph-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="metamorph-views"
```

## Usage

```php
$dataModel = new CrucialDigital\DataModel();
echo $dataModel->echoPhrase('Hello, CrucialDigital!');
```
